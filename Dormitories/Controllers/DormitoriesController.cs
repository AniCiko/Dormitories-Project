...
namespace Dormitories.Controllers
{
    public class DormitoriesController : Controller
    {
        ...
        public DormitoriesController(DormitoriesDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Dormitories != null ? 
                          ...
                          Problem("Entity set 'DormitoriesDbContext.Dormitories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,CurrentCapacity,MaxCapacity")] Entities.Dormitories dormitories)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,CurrentCapacity,MaxCapacity")] Entities.Dormitories dormitories)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DormitoriesDbContext.Dormitories'  is null.");
            }
            var dormitories = await _context.Dormitories.FindAsync(id);
            if (dormitories != null)
            {
