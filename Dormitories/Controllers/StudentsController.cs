...
namespace Dormitories.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(DormitoriesDbContext context)
        {
            _context = context;
        }
        ...
        {
            var dormitoriesDbContext = _context.Students.Include(s => s.Dormitories);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DormitoriesDbContext.Students'  is null.");
            }
            var students = await _context.Students.FindAsync(id);
            if (students != null)
            {
